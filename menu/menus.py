...
class BuildMenu(Menu):
    def __init__(self, x, y):
        ...
        """
        self._buttons = [
                         Button(RAPID_TEST_BTN_IMAGE, "rapid test", self.rect.centerx, self.rect.centery - 70),
                         Button(PCR_BTN_IMAGE, "pcr", self.rect.centerx-60, self.rect.centery+10),
                         Button(ALCOHOL_BTN_IMAGE, "alcohol", self.rect.centerx, self.rect.centery + 80),
                        ]
        pass
